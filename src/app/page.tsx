  ...
  return (
    <div className="bg-orange-100 dark:bg-gray-900 min-h-screen">
      ...
      <main className="h-auto flex flex-col gap-5 justify-self-center pt-5">
        <div className="flex flex-col p-9 bg-violet-300 dark:bg-indigo-950 dark:border-violet-900 border-2 rounded-lg items-center text-center gap-4 w-fit">
        ...
        <div className="w-full bg-pink-600/50 border-pink-600/80 dark:bg-pink-950 dark:border-pink-800  border-2 rounded-lg p-4 gap-2 flex flex-col">
        ...
        <div className="pb-5 flex justify-center">
          <nav className="self-center gap-6 flex flex-row">
            <Link
              href="/log"
              className="block p-4 bg-blue-500 dark:bg-blue-900 border-2 dark:border-blue-700/50 hover:opacity-90  rounded"
            >
              Log Workout
            </Link>
            <Link
              href="/workouts"
              className="block p-4 bg-green-500 dark:bg-green-900 border-2 dark:border-green-700/50 hover:opacity-90 text-white rounded"
            >
              View Workouts
            </Link>
          </nav>
